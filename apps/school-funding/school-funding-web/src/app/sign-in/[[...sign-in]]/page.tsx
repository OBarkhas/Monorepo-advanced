...
export default function Page() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-teal-600 via-emerald-500 to-teal-700 relative overflow-hidden">
      {}
      ...
      <div className="relative z-10">
        <div className="text-center mb-6">
          ...
          <p className="text-teal-100 mt-1 text-sm">
            Sign in to continue to School Funding
          </p>
        </div>
        <SignIn
          appearance={{
