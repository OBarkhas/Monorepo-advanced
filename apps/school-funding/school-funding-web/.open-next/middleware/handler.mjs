...
var require_ead_next_dist_esm_api_headers_9ffadde2 = __commonJS({
  ".next/server/edge/chunks/49ead_next_dist_esm_api_headers_9ffadde2.js"() {
    ...
    (globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/49ead_next_dist_esm_api_headers_9ffadde2.js", 68349, (e) => {
      ...
      }), e.s(["draftMode", () => v], 72671), e.s([], 17911), e.i(17911), e.i(2696), e.i(24239), e.i(72671), e.s(["cookies", () => g, "draftMode", () => v, "headers", () => _], 68349);
    }]);
  }
});
    ...
    (globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/[root-of-the-server]__3b0c71de._.js", 14415, (e, t, r) => {
      ...
      var i = { 226: function(t2, r2) {
        !function(i2, s2) {
          ...
          if (Y.VERSION = "1.0.35", Y.BROWSER = K([d, f, c]), Y.CPU = K([m]), Y.DEVICE = K([u, p, h, g, y, b, _, v, w]), Y.ENGINE = Y.OS = K([d, f]), typeof r2 !== a) t2.exports && (r2 = t2.exports = Y), r2.UAParser = Y;
...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      function L(e10, t10) {
        ...
        let i10 = M.get(t10);
        i10 || (i10 = t10.map((e11) => e11.toLowerCase()), M.set(t10, i10));
        let s10 = e10.split("/", 2);
      ...
      class $ {
        ...
        analyze() {
          ...
          let n10 = function(e11, t11) {
            ...
            if (i11) {
              let e12 = t11.i18nProvider ? t11.i18nProvider.analyze(n11.pathname) : L(n11.pathname, i11.locales);
              n11.locale = e12.detectedLocale, n11.pathname = e12.pathname ?? n11.pathname, !e12.detectedLocale && n11.buildId && (e12 = t11.i18nProvider ? t11.i18nProvider.analyze(a11) : L(a11, i11.locales)).detectedLocale && (n11.locale = e12.detectedLocale);
            }
            return n11;
      ...
      e.i(76047);
      var eq = e.i(40128), eM = e.i(13780), eL = e.i(93184);
      e.i(73193);
      var eD = e.i(1242);
      e.i(51615);
      ...
      let e8 = { get url() {
        return `file://${e.P("node_modules/.bun/@clerk+shared@4.25.5+7492c01c6988791b/node_modules/@clerk/shared/dist/getEnvVariable.mjs")}`;
...
Clerk Trace ID: ${this.clerkTraceId}`), e11;
      ...
      } }), tA = "token-expired", tN = "token-invalid", tU = "token-invalid-signature", tq = "token-not-active-yet", tM = "token-iat-in-the-future", tL = "token-verification-failed", tD = "jwk-remote-failed-to-load", tj = "jwk-failed-to-resolve", tB = "Contact support@clerk.com", t$ = "Make sure that this is a valid Clerk-generated JWT.", tz = "Set the CLERK_JWT_KEY environment variable.", tK = class e10 extends Error {
      ...
      var tG = fetch.bind(globalThis), tX = { crypto: tW, get fetch() {
        ...
        if (!i10.includes(e10)) throw new tK({ action: t$, reason: tN, message: `Invalid JWT type ${JSON.stringify(e10)}. Expected "${i10.join(", ")}".` });
      }, t5 = (e10) => {
        if (!t2.includes(e10)) throw new tK({ action: t$, reason: "token-invalid-algorithm", message: `Invalid JWT algorithm ${JSON.stringify(e10)}. Supported: ${t2}.` });
      };
      async function t3(e10, t10) {
        ...
        try {
          ...
          return { errors: [new tK({ reason: tU, message: e11?.message })] };
        }
      }
      function t6(e10) {
        let t10 = (e10 || "").toString().split(".");
        if (3 !== t10.length) return { errors: [new tK({ reason: tN, message: "Invalid JWT form. A JWT consists of three parts separated by dots." })] };
      ...
      async function t8(e10, t10) {
        ...
        if (p2) return { errors: [new tK({ action: t$, reason: tL, message: `Error verifying JWT signature. ${p2[0]}` })] };
        if (!h2) return { errors: [new tK({ reason: tU, message: "JWT signature is invalid." })] };
        try {
          let { azp: e11, sub: t11, aud: s11, iat: n11, exp: a11, nbf: l11 } = d2;
          if ("string" != typeof t11) throw new tK({ action: t$, reason: tL, message: `Subject claim (sub) is required and must be a string. Received ${JSON.stringify(t11)}.` });
          let c3 = [r10].flat().filter((e12) => !!e12), u3 = [s11].flat().filter((e12) => !!e12);
          if (c3.length > 0 && u3.length > 0) {
            if ("string" == typeof s11) {
              if (!c3.includes(s11)) throw new tK({ action: t$, reason: tL, message: `Invalid JWT audience claim (aud) ${JSON.stringify(s11)}. Is not included in "${JSON.stringify(c3)}".` });
            } else if (Array.isArray(s11) && s11.length > 0 && s11.every((e12) => "string" == typeof e12) && !s11.some((e12) => c3.includes(e12))) throw new tK({ action: t$, reason: tL, message: `Invalid JWT audience claim array (aud) ${JSON.stringify(s11)}. Is not included in "${JSON.stringify(c3)}".` });
          }
          if (i10 && 0 !== i10.length && (!e11 || !i10.includes(e11))) throw new tK({ reason: "token-invalid-authorized-parties", message: `Invalid JWT Authorized party claim (azp) ${JSON.stringify(e11)}. Expected "${i10}".` });
          if ("number" != typeof a11) throw new tK({ action: t$, reason: tL, message: `Invalid JWT expiry date claim (exp) ${JSON.stringify(a11)}. Expected number.` });
          let h3 = new Date(Date.now()), p3 = /* @__PURE__ */ new Date(0);
          if (p3.setUTCSeconds(a11), p3.getTime() <= h3.getTime() - o10) throw new tK({ reason: tA, message: `JWT is expired. Expiry date: ${p3.toUTCString()}, Current date: ${h3.toUTCString()}.` });
          ((e12, t12) => {
            if (void 0 === e12) return;
            if ("number" != typeof e12) throw new tK({ action: t$, reason: tL, message: `Invalid JWT not before date claim (nbf) ${JSON.stringify(e12)}. Expected number.` });
            let r11 = new Date(Date.now()), i11 = /* @__PURE__ */ new Date(0);
            if (i11.setUTCSeconds(e12), i11.getTime() > r11.getTime() + t12) throw new tK({ reason: tq, message: `JWT cannot be used prior to not before date claim (nbf). Not before date: ${i11.toUTCString()}; Current date: ${r11.toUTCString()};` });
          })(l11, o10), ((e12, t12) => {
            if (void 0 === e12) return;
            if ("number" != typeof e12) throw new tK({ action: t$, reason: tL, message: `Invalid JWT issued at date claim (iat) ${JSON.stringify(e12)}. Expected number.` });
            let r11 = new Date(Date.now()), i11 = /* @__PURE__ */ new Date(0);
            if (i11.setUTCSeconds(e12), i11.getTime() > r11.getTime() + t12) throw new tK({ reason: tM, message: `JWT issued at date claim (iat) is in the future. Issued at date: ${i11.toUTCString()}; Current date: ${r11.toUTCString()};` });
          })(n11, o10);
        } catch (e11) {
          return { errors: [e11] };
        }
      ...
      }), rC = "https://api.clerk.com", rP = "@clerk/backend@3.11.7", rI = "2026-05-12", rR = { Session: "__session", Refresh: "__refresh", ClientUat: "__client_uat", Handshake: "__clerk_handshake", DevBrowser: "__clerk_db_jwt", RedirectCount: "__clerk_redirect_count", HandshakeNonce: "__clerk_handshake_nonce" }, rA = { ClerkSynced: "__clerk_synced", SuffixedCookies: "suffixed_cookies", ClerkRedirectUrl: "__clerk_redirect_url", DevBrowser: rR.DevBrowser, Handshake: rR.Handshake, HandshakeHelp: "__clerk_help", LegacyDevBrowser: "__dev_session", HandshakeReason: "__clerk_hs_reason", HandshakeNonce: rR.HandshakeNonce, HandshakeFormat: "format", Session: "__session" }, rN = { NeedsSync: "false", Completed: "true" }, rU = "accept", rq = "x-clerk-auth-message", rM = "authorization", rL = "x-clerk-auth-reason", rD = "x-clerk-auth-signature", rj = "x-clerk-auth-status", rB = "x-clerk-auth-token", r$ = "cache-control", rz = "x-clerk-redirect-to", rK = "x-clerk-request-data", rH = "x-clerk-clerk-url", rJ = "cloudfront-forwarded-proto", rF = "content-type", rV = "content-security-policy", rW = "content-security-policy-report-only", rG = "x-clerk-debug", rX = "x-forwarded-host", rY = "x-forwarded-proto", rQ = "host", rZ = "location", r0 = "x-nonce", r1 = "origin", r2 = "referer", r4 = "sec-fetch-dest", r5 = "user-agent", r3 = "reporting-endpoints", r6 = "application/json", r8 = (e10, t10, r10, i10, s10) => {
      ...
      var it = "session_token", ir = "api_key", ii = "m2m_token", is = "oauth_token", ia = class {
        ...
        isKnownClerkReferrer() {
          ...
          try {
            ...
            if (tr.some((e11) => t10.startsWith("accounts.") && t10.endsWith(e11)) || ti.some((e11) => t10.endsWith(e11) && !t10.endsWith(".clerk" + e11))) return true;
      ...
      var iu = class {
      ...
      }, iq = "/instance", iM = class extends iu {
        async get() {
      ...
      }, iL = "/invitations", iD = class extends iu {
        async getInvitationList(e10 = {}) {
          return this.request({ method: "GET", path: iL, queryParams: { ...e10, paginated: true } });
        }
        async createInvitation(e10) {
          return this.request({ method: "POST", path: iL, bodyParams: e10 });
        }
        async createInvitationBulk(e10) {
          return this.request({ method: "POST", path: ic(iL, "bulk"), bodyParams: e10 });
        }
        async revokeInvitation(e10) {
          return this.requireId(e10), this.request({ method: "POST", path: ic(iL, e10, "revoke") });
        }
      ...
      }, iz = /* @__PURE__ */ new Set(["iss", "sub", "exp", "nbf", "iat", "jti"]), iK = class e10 {
        constructor(e11, t10, r10, i10, s10, n10, a10, o10, l10, c2, u2) {
        ...
        static fromJwtPayload(t10, r10 = 5e3) {
          return new e10(t10.jti ?? "", t10.sub, t10.scopes?.split(" ") ?? t10.aud ?? [], function(e11) {
            let t11 = {};
            for (let r11 of Object.keys(e11)) iz.has(r11) || (t11[r11] = e11[r11]);
      ...
      function iV(e10) {
        ...
        if (s10) return s10;
        if (!r10) throw new tK({ action: tz, message: "Missing local JWK.", reason: "jwk-local-missing" });
      ...
      async function iW(e10) {
        ...
        if (n10 || function() {
          ...
          if (!t10) throw new tK({ action: tB, message: "Failed to load JWKS from Clerk Backend or Frontend API.", reason: tD });
          let { keys: e11 } = await tw(() => iG(r10, t10, i10));
          if (!e11 || !e11.length) throw new tK({ action: tB, message: "The JWKS endpoint did not contain any signing keys. Contact support@clerk.com.", reason: tD });
      ...
      async function iG(e10, t10, r10) {
        if (!t10) throw new tK({ action: "Set the CLERK_SECRET_KEY environment variable.", message: "Missing Clerk Secret Key or API Key. Go to https://dashboard.clerk.com and get your key for your instance.", reason: tD });
        let i10 = new URL(e10);
        ...
        if (!s10.ok) {
          ...
          if (t11) throw new tK({ action: tB, message: t11.message, reason: "secret-key-invalid" });
          throw new tK({ action: tB, message: `Error loading Clerk JWKS from ${i10.href} with code=${s10.status}`, reason: tD });
        }
        return s10.json();
      }
      ...
      async function st(e10, t10, r10, i10) {
        try {
          ...
          if (r10.jwtKey) s10 = iV({ kid: t10, pem: r10.jwtKey });
            ...
            if (!r10.secretKey) return { error: new tV({ action: tz, message: "Failed to resolve JWK during verification.", code: tF }) };
      ...
      async function sr(e10, t10, r10) {
        ...
        return "error" in s10 ? { data: void 0, tokenType: ii, errors: [s10.error] } : { data: iK.fromJwtPayload(s10.payload, r10.clockSkewInMs), tokenType: ii, errors: void 0 };
      }
      ...
      var ss = "/m2m_tokens", sn = class extends iu {
        constructor(e10, t10 = {}) {
          super(e10), ra(this, oK), ra(this, oz), ((e11, t11, r10, i10) => (rn(e11, t11, "write to private field"), i10 ? i10.call(e11, r10) : t11.set(e11, r10)))(this, oz, t10);
        }
        async list(e10) {
          let { machineSecretKey: t10, ...r10 } = e10, i10 = ro(this, oK, oH).call(this, { method: "GET", path: ss, queryParams: r10 }, t10);
          return this.request(i10);
        }
        async createToken(e10) {
          let { claims: t10 = null, machineSecretKey: r10, minRemainingTtlSeconds: i10, secondsUntilExpiration: s10 = null, tokenFormat: n10 = "opaque" } = e10 || {}, a10 = ro(this, oK, oH).call(this, { method: "POST", path: ss, bodyParams: { secondsUntilExpiration: s10, claims: t10, minRemainingTtlSeconds: i10, tokenFormat: n10 } }, r10);
          return this.request(a10);
        }
        async revokeToken(e10) {
          let { m2mTokenId: t10, revocationReason: r10 = null, machineSecretKey: i10 } = e10;
          this.requireId(t10);
          let s10 = ro(this, oK, oH).call(this, { method: "POST", path: ic(ss, t10, "revoke"), bodyParams: { revocationReason: r10 } }, i10);
          return this.request(s10);
        }
        async verify(e10) {
          let { token: t10, machineSecretKey: r10 } = e10;
          if (i3(t10)) return ro(this, oK, oJ).call(this, t10);
          let i10 = ro(this, oK, oH).call(this, { method: "POST", path: ic(ss, "verify"), bodyParams: { token: t10 } }, r10);
          return this.request(i10);
        }
      };
      oz = /* @__PURE__ */ new WeakMap(), oK = /* @__PURE__ */ new WeakSet(), oH = function(e10, t10) {
        ...
        let s10 = await sr(e10, t10, (rn(this, r10 = oz, "read from private field"), i10 ? i10.call(this) : r10.get(this)));
      ...
      var sa = class extends iu {
      ...
      }, sq = "/waitlist_entries", sM = class extends iu {
        async list(e10 = {}) {
      ...
      }, sL = "/webhooks", sD = class extends iu {
        async createSvixApp() {
          return this.request({ method: "POST", path: ic(sL, "svix") });
        }
        async generateSvixAuthURL() {
          return this.request({ method: "POST", path: ic(sL, "svix_url") });
        }
        async deleteSvixApp() {
          return this.request({ method: "DELETE", path: ic(sL, "svix") });
        }
      ...
      }, s$ = (e10) => "object" == typeof e10 && null !== e10, sz = (e10) => s$(e10) && !(e10 instanceof RegExp) && !(e10 instanceof Error) && !(e10 instanceof Date) && !(globalThis.Blob && e10 instanceof globalThis.Blob), sK = Symbol("mapObjectSkip"), sH = (e10, t10, r10, i10 = /* @__PURE__ */ new WeakMap()) => {
        if (r10 = { deep: false, target: {}, ...r10 }, i10.has(e10)) return i10.get(e10);
        i10.set(e10, r10.target);
        let { target: s10 } = r10;
        delete r10.target;
        let n10 = (e11) => e11.map((e12) => sz(e12) ? sH(e12, t10, r10, i10) : e12);
        ...
        for (let [a10, o10] of Object.entries(e10)) {
          ...
          "__proto__" !== c2 && (r10.deep && d2 && sz(u2) && (u2 = Array.isArray(u2) ? n10(u2) : sH(u2, t10, r10, i10)), s10[c2] = u2);
        }
        return s10;
      };
      ...
      var s4 = function(e10, t10) {
        ...
        static fromJSON(t10) {
          return new e10(t10.id, t10.name, t10.key, t10.description, (t10.permissions ?? []).map((e11) => nM.fromJSON(e11)), t10.is_creator_eligible, t10.created_at, t10.updated_at);
        }
      }, n$ = class e10 {
        constructor(e11, t10, r10, i10, s10, n10, a10, o10) {
        ...
        static fromJSON(t10) {
          return new e10(t10.id, t10.name, t10.key, t10.description, (t10.roles ?? []).map((e11) => n$.fromJSON(e11)), t10.default_role ? n$.fromJSON(t10.default_role) : null, t10.creator_role ? n$.fromJSON(t10.creator_role) : null, t10.type, t10.role_set_migration ? nz.fromJSON(t10.role_set_migration) : null, t10.created_at, t10.updated_at);
        }
      }, nH = class e10 {
      ...
      function n2(e10) {
        ...
        return t10 = async (t11) => {
          ...
          let v2 = new Headers({ "Clerk-API-Version": rI, [r5]: c2, ...f2 }), w2 = rM;
      ...
      function n6(e10) {
        let t10 = n2(e10);
        return { __experimental_accountlessApplications: new iy(n2({ ...e10, requireSecretKey: false })), actorTokens: new ih(t10), agentTasks: new im(t10), allowlistIdentifiers: new ib(t10), apiKeys: new iw(n2({ ...e10, skipApiVersionInUrl: true })), betaFeatures: new ik(t10), blocklistIdentifiers: new iE(t10), billing: new sB(t10), clients: new ix(t10), domains: new iC(t10), emailAddresses: new iI(t10), emails: new iR(t10), enterpriseConnections: new iN(t10), idPOAuthAccessToken: new iU(n2({ ...e10, skipApiVersionInUrl: true })), instance: new iM(t10), invitations: new iD(t10), jwks: new sa(t10), jwtTemplates: new sl(t10), machines: new iB(t10), m2m: new sn(n2({ ...e10, skipApiVersionInUrl: true, requireSecretKey: false, useMachineSecretKey: true }), { secretKey: e10.secretKey, apiUrl: e10.apiUrl, jwtKey: e10.jwtKey }), oauthApplications: new sg(t10), organizations: new su(t10), organizationPermissions: new sh(t10), organizationRoles: new sf(t10), phoneNumbers: new s_(t10), proxyChecks: new sb(t10), redirectUrls: new sw(t10), roleSets: new sS(t10), sessions: new sO(t10), signInTokens: new sP(t10), signUps: new sR(t10), testingTokens: new sA(t10), users: new sU(t10), waitlistEntries: new sM(t10), webhooks: new sD(t10), samlConnections: new sT(t10) };
      }
      var n8 = (e10) => () => {
        let t10 = { ...e10 };
      ...
      async function a_(e10, t10) {
        ...
        if (s10.cat === iZ) return { errors: [new tK({ action: t$, reason: tN, message: "Invalid session token category." })] };
        try {
          let r11;
          if (t10.jwtKey) r11 = iV({ kid: n10, pem: t10.jwtKey });
          else {
            if (!t10.secretKey) return { errors: [new tK({ action: tz, message: "Failed to resolve JWK during verification.", reason: tj })] };
      ...
      async function aE(e10, { key: t10 }) {
        ...
        if (c2) throw new tK({ reason: tL, message: `Error verifying handshake token. ${c2[0]}` });
        if (!l10) throw new tK({ reason: tU, message: "Handshake signature is invalid." });
        return n10;
      }
      async function aT(e10, t10) {
        ...
        else throw new tK({ action: tz, message: "Failed to resolve JWK during handshake verification.", reason: tj });
      ...
      var ax = class {
        ...
        async resolveHandshake() {
          ...
          if ("development" === this.authenticateContext.instanceType && (s10?.reason === tA || s10?.reason === tq || s10?.reason === tM)) {
            let t11 = new tK({ action: s10.action, message: s10.message, reason: s10.reason });
...
${e12.message}`);
      ...
      var aP = async (e10, t10) => {
        ...
        async function h2() {
          ...
          if (r10.handshakeNonce || r10.handshakeToken) try {
            ...
            e12 instanceof tK && "development" === r10.instanceType ? o10.handleTokenVerificationErrorInDevelopment(e12) : console.error("Clerk: unable to resolve handshake:", e12);
          }
        ...
        async function p2(t11, i11) {
          let s11;
          if (!(t11 instanceof tK)) return ac({ tokenType: it, authenticateContext: r10, reason: ao });
          ...
          return (t11.tokenCarrier = i11, [tA, tq, tM].includes(t11.reason)) ? u2(r10, aR({ tokenError: t11.reason, refreshError: s11 }), t11.getFullMessage()) : ac({ tokenType: it, authenticateContext: r10, reason: t11.reason, message: t11.getFullMessage() });
        }
        function f2(e11, t11) {
      ...
      async function aD(e10, t10) {
        let r10, i10, s10, n10 = aM(t10?.proxyPath || tc), a10 = t10?.publishableKey || ("u" > typeof process ? process.env?.CLERK_PUBLISHABLE_KEY : void 0), o10 = t10?.secretKey || ("u" > typeof process ? process.env?.CLERK_SECRET_KEY : void 0);
        if (!a10) return aL("proxy_configuration_error", "Missing publishableKey. Provide it in options or set CLERK_PUBLISHABLE_KEY environment variable.", 500);
        if (!o10) return aL("proxy_configuration_error", "Missing secretKey. Provide it in options or set CLERK_SECRET_KEY environment variable.", 500);
        let l10 = new URL(e10.url);
        if (!(l10.pathname === n10 || l10.pathname.startsWith(n10 + "/"))) return aL("proxy_path_mismatch", `Request path "${l10.pathname}" does not match proxy path "${n10}"`, 400);
        let c2 = (r10 = tp(a10)?.frontendApi, r10?.startsWith("clerk.") && tr.some((e11) => r10?.endsWith(e11)) ? tl : tn.some((e11) => r10?.endsWith(e11)) ? "https://frontend-api.lclclerk.com" : ta.some((e11) => r10?.endsWith(e11)) ? "https://frontend-api.clerkstage.dev" : tl), u2 = new URL(c2).host, d2 = l10.pathname.slice(n10.length) || "/", h2 = new URL(`${c2}${d2}`);
        if (h2.search = l10.search, h2.host !== u2) return aL("proxy_request_failed", "Resolved target does not match the expected host", 400);
        let p2 = new Headers(), f2 = aU(e10.headers);
        e10.headers.forEach((e11, t11) => {
          let r11 = t11.toLowerCase();
          aN.has(r11) || f2.has(r11) || p2.set(t11, e11);
        });
        ...
        let _2 = null !== e10.body;
        try {
          let t11 = { method: e10.method, headers: p2, redirect: "manual" };
          _2 && (t11.duplex = "half", t11.body = e10.body);
          let r11 = await fetch(h2.toString(), t11), i11 = aU(r11.headers), s11 = new Headers();
          r11.headers.forEach((e11, t12) => {
            let r12 = t12.toLowerCase();
            aN.has(r12) || aq.has(r12) || i11.has(r12) || ("set-cookie" === r12 ? s11.append(t12, e11) : s11.set(t12, e11));
          });
          let n11 = r11.headers.get("location");
          if (n11) try {
            let e11 = new URL(n11, c2);
            if (e11.host === u2) {
          ...
          for (let e11 of aq) a11.headers.delete(e11);
          return a11;
        } catch (t11) {
          let e11 = t11 instanceof Error ? t11.message : "Unknown error";
          return aL("proxy_request_failed", `Failed to proxy request to Clerk FAPI: ${e11}`, 502);
        }
      }
      ...
      let az = "x-middleware-rewrite", aK = "x-middleware-next", aH = "Location", aJ = "next-url", aF = "next-action", aV = "x-nextjs-data", aW = (e10, t10, r10) => (e10.headers.set(t10, r10), e10), aG = "__clerk_db_jwt";
      var aX = e.i(22650);
        ...
        let i10 = ("string" == typeof e10 ? () => {
          ...
          return { enable: () => {
            ...
            if (r11) {
              ...
              console.log((s11 = e10, `[clerk debug end: ${s11}] (@clerk/nextjs=7.5.20,next=${aX.default.version},timestamp=${Math.round((/* @__PURE__ */ new Date()).getTime() / 1e3)})`));
            }
          } };
        } : e10)(), s10 = t10(i10);
        try {
...
Original error: ${e10}`);
      ...
      let oE = { secretKey: a5, publishableKey: a6, apiUrl: a9, apiVersion: a4, userAgent: "@clerk/nextjs@7.5.20", proxyUrl: oe, domain: a7, isSatellite: ot, machineSecretKey: a3, sdkMetadata: { name: "@clerk/nextjs", version: "7.5.20", environment: "production" }, telemetry: { disabled: os, debug: on } }, oT = (e10) => {
        var t10;
      ...
      var oI, oR, oA, oN, oU, oq, oM, oL, oD, oj, oB, o$, oz, oK, oH, oJ, oF, oV, oW, oG, oX, oY, oQ, oZ, o0 = Object.defineProperty, o1 = (null == (oW = "u" > typeof globalThis ? globalThis : void 0) ? void 0 : oW.crypto) || (null == (oG = e.g) ? void 0 : oG.crypto) || (null == (oX = "u" > typeof self ? self : void 0) ? void 0 : oX.crypto) || (null == (oQ = null == (oY = "u" > typeof frames ? frames : void 0) ? void 0 : oY[0]) ? void 0 : oQ.crypto);
      oZ = o1 ? (e10) => {
        let t10 = [];
      ...
      z = 0, (null == (K = aX.default) ? void 0 : K.version) && isNaN(parseInt(aX.default.version.split(".")[0], 10));
      let lM = `
...
For more information, see: https://clerk.com/docs/reference/nextjs/clerk-middleware#dynamic-keys. (code=encryption_key_invalid)`, lj = tP({ packageName: "@clerk/nextjs" }), lB = "x-middleware-override-headers", l$ = "x-middleware-request", lz = (e10, t10, r10) => {
      ...
      }, lK = (e10) => Q.redirect(e10, { headers: { [rz]: "true" } }), lH = "clerk_keyless_dummy_key";
      function lJ() {
      ...
      let lV = async () => {
        ...
        let r10;
        try {
          let e11 = await og(), t11 = ox(e11, rK);
          r10 = function(e12) {
            if (!e12) return {};
      ...
      async function lY() {
        ...
        if (!e10) return `${lG}0`;
        let t10 = e10.split("/").filter(Boolean).slice(-3).reverse().join("/"), r10 = await lX(t10);
        return `${lG}${r10}`;
      }
      async function lQ(e10) {
        let t10;
        if (!oo) return;
        let r10 = await lY();
        try {
      ...
      let lZ = "CLERK_PROTECT_REDIRECT_TO_SIGN_IN", l0 = "CLERK_PROTECT_REDIRECT_TO_SIGN_UP", l1 = { NOT_FOUND: 404, FORBIDDEN: 403, UNAUTHORIZED: 401 }, l2 = new Set(Object.values(l1)), l4 = "NEXT_HTTP_ERROR_FALLBACK";
      function l5(e10) {
        if (!function(e11) {
          if ("object" != typeof e11 || null === e11 || !("digest" in e11) || "string" != typeof e11.digest) return false;
          let [t11, r10] = e11.digest.split(";");
          return t11 === l4 && l2.has(Number(r10));
        }(e10)) return;
        let [, t10] = e10.digest.split(";");
        return Number(t10);
      }
      let l3 = "NEXT_REDIRECT";
      function l6(e10, t10, r10 = "replace", i10 = 307) {
        let s10 = Error(l3);
        throw s10.digest = `${l3};${r10};${e10};${i10};`, s10.clerk_digest = "CLERK_PROTECT_REDIRECT_TO_URL", Object.assign(s10, t10), s10;
      }
      function l8(e10, t10) {
      ...
      function l9(e10) {
        ...
        return r10 === l3 && ("replace" === i10 || "push" === i10) && "string" == typeof s10 && !isNaN(n10) && 307 === n10;
      }
      function l7() {
        let e10 = Error(l4);
        throw e10.digest = `${l4};${l1.UNAUTHORIZED}`, e10;
      }
      let ce = ["role", "permission", "feature", "plan", "reverification"], ct = (e10) => {
        var t10, r10;
      ...
      }, cr = (e10) => !!e10.headers.get(aJ) && !ct(e10) || ci(), ci = () => {
        ...
        return !!t10;
      }, cs = (e10) => !!e10.headers.get(aV);
      async function cn({ clerkRequest: e10, request: t10, event: r10, requestState: i10, handler: s10, options: n10, resolvedParams: a10, keyless: o10, logger: l10 }) {
        var c2, u2, d2, h2, p2;
        ...
        let _2 = ca(e10), b2 = co(e10), v2 = await cl(e10, y2, _2), w2 = cc(i10, _2, b2);
        w2.protect = v2;
        let k2 = Q.next();
        try {
          k2 = await oP.run(oC, async () => null == s10 ? void 0 : s10(w2, t10, r10)) || k2;
        } catch (r11) {
          k2 = cu(r11, e10, t10, i10);
        }
        if (n10.contentSecurityPolicy) {
          let t11, r11, i11, s11, { headers: a11 } = (d2 = (null != (u2 = null == (c2 = tp(f2)) ? void 0 : c2.frontendApi) ? u2 : "").replace("$", ""), h2 = n10.contentSecurityPolicy, t11 = [], i11 = h2.strict ? (r11 = new Uint8Array(16), crypto.getRandomValues(r11), btoa(Array.from(r11, (e11) => String.fromCharCode(e11)).join(""))) : void 0, s11 = function(e11, t12, r12, i12) {
            let s12 = Object.entries(lW.DEFAULT_DIRECTIVES).reduce((e12, [t13, r13]) => (e12[t13] = new Set(r13), e12), {});
            if (s12["connect-src"].add(t12), e11 && (s12["script-src"].delete("http:"), s12["script-src"].delete("https:"), s12["script-src"].add("'strict-dynamic'"), i12 && s12["script-src"].add(`'nonce-${i12}'`)), r12) {
              ...
              Object.entries(r12).forEach(([t13, r13]) => {
                ...
                lW.DEFAULT_DIRECTIVES[t13] ? function(e13, t14, r14) {
            ...
            return Object.entries(s12).sort(([e12], [t13]) => e12.localeCompare(t13)).map(([e12, t13]) => {
              let r13 = Array.from(t13).map((e13) => ({ raw: e13, formatted: lW.formatValue(e13) }));
          ...
          }), lz(k2, e10, o11), l10.debug("Clerk generated CSP", () => ({ headers: a11 }));
        }
        if (i10.headers && i10.headers.forEach((e11, t11) => {
          ...
          if ("true" === t11.headers.get(rz) && i11 && tg(r11.secretKey) && e11.clerkUrl.isCrossOrigin(i11)) {
            var s11;
        ...
        return !function(e11, t11, r11, i11, s11, n11) {
          ...
          "1" === t11.headers.get(aK) && (t11.headers.delete(aK), a11 = new URL(e11.url));
          let d3 = t11.headers.get(az);
          if (d3) {
          ...
          if (a11) {
            ...
            lz(t11, e11, { [rj]: c3, [rB]: u3 || "", [rD]: u3 ? lq(u3, (null == i11 ? void 0 : i11.secretKey) || a5 || s11.secretKey || "").toString() : "", [rq]: l11 || "", [rL]: o11 || "", [rH]: e11.clerkUrl.toString(), ...r12 ? { [rK]: r12 } : {} }), t11.headers.set(az, a11.href);
          }
      ...
      let ca = (e10) => (t10 = {}) => {
        var r10;
        r10 = e10.clerkUrl.toString(), l6(r10, { clerk_digest: lZ, returnBackUrl: l8(r10, t10.returnBackUrl) });
      }, co = (e10) => (t10 = {}) => {
        var r10;
        r10 = e10.clerkUrl.toString(), l6(r10, { clerk_digest: l0, returnBackUrl: l8(r10, t10.returnBackUrl) });
      }, cl = (e10, t10, r10) => async (i10, s10) => function(e11) {
        ...
        return async (...e12) => {
          ...
          let m2 = ((e13) => {
            ...
            let t12 = {};
            for (let r12 of ce) void 0 !== e13[r12] && (t12[r12] = e13[r12]);
          ...
          if ("pending" === r11.sessionStatus || !r11.userId) {
            return g2 ? i11(g2) : "document" === (p2 = n10).headers.get(r4) || "iframe" === p2.headers.get(r4) || (null == (f2 = p2.headers.get(rU)) ? void 0 : f2.includes("text/html")) || cr(p2) || cs(p2) ? t11() : ct(n10) ? a10() : s11();
          }
          return m2 ? "function" == typeof m2 ? m2(r11.has) ? r11 : b2() : r11.has(m2) ? r11 : b2() : r11;
        };
      }({ request: e10, redirect: (e11) => l6(e11, { redirectUrl: e11 }), notFound: () => function() {
      ...
      }(), unauthorized: l7, authObject: at({ authObject: t10, acceptsToken: (null == i10 ? void 0 : i10.token) || (null == s10 ? void 0 : s10.token) || it }), redirectToSignIn: r10 })(i10, s10), cc = (e10, t10, r10) => async (i10) => {
        var s10;
        ...
        if ("object" == typeof e10 && null !== e10 && "digest" in e10 && "NEXT_NOT_FOUND" === e10.digest || l5(e10) === l1.NOT_FOUND) return aW(Q.rewrite(new URL(`/clerk_${Date.now()}`, r10.url)), rL, "protect-rewrite");
        let n10 = !!l9(e10) && "clerk_digest" in e10 && e10.clerk_digest === lZ, a10 = !!l9(e10) && "clerk_digest" in e10 && e10.clerk_digest === l0;
        if (n10 || a10) {
          let r11 = ((e11) => {
          ...
          })({ redirectAdapter: lK, baseUrl: t10.clerkUrl, signInUrl: i10.signInUrl, signUpUrl: i10.signUpUrl, publishableKey: i10.publishableKey, sessionStatus: null == (s10 = i10.toAuth()) ? void 0 : s10.sessionStatus, isSatellite: i10.isSatellite }), { returnBackUrl: a11 } = e10;
          return r11[n10 ? "redirectToSignIn" : "redirectToSignUp"]({ returnBackUrl: a11 });
        }
        if (l9(e10)) return lK(e10.redirectUrl);
        throw e10;
      }, cd = ((...e10) => {
        ...
        return oP.run(oC, () => {
          let e11 = a1("clerkMiddleware", (e12) => async (t12, r12) => {
            ...
            let u2 = "function" == typeof a10 ? await a10(t12) : a10, d2 = await lQ((e13) => {
              var r13;
            ...
            if (!m2 && !g2 && !rg() && tm(h2) && rf(f2.hostname) && (m2 = { enabled: true }), m2) {
              ...
              if (("function" == typeof i12 ? i12(f2) : i12) && (c2 = { proxyPath: s12 }, e13 = aM(c2?.proxyPath || tc), (r13 = new URL(t12.url)).pathname === e13 || r13.pathname.startsWith(e13 + "/"))) return aD(t12, { proxyPath: s12, publishableKey: h2, secretKey: p2 });
            }
            ...
            let k2 = await _2.authenticateRequest(b2, ((e13, t13) => {
              ...
              return { ...r13, ...((e14, t14) => {
                ...
                if (s12 && !r14 && !n11) throw Error(lM);
                if (s12 && !rh(a11) && tg(t14.secretKey || a5)) throw Error(lL);
                return { proxyUrl: r14, isSatellite: s12, domain: n11, signInUrl: a11 };
              })(e13, r13), acceptsToken: "any" };
            })(b2, y2));
            return cn({ clerkRequest: b2, request: t12, event: r12, requestState: k2, handler: n10, options: y2, resolvedParams: u2, keyless: d2, logger: e12 });
          }), t11 = a1("clerkMiddleware", (e12) => async (t12, r12) => {
            let i11 = "function" == typeof a10 ? await a10(t12) : a10, s11 = await lQ((e13) => {
              var r13;
              return null == (r13 = t12.cookies.get(e13)) ? void 0 : r13.value;
            ...
            let u2 = am(t12);
            return e12.debug("keyless bootstrap (no publishable key)", () => ({ signInUrl: o11, signUpUrl: l10 })), e12.debug("url", () => u2.toJSON()), cn({ clerkRequest: u2, request: t12, event: r12, requestState: function({ signInUrl: e13 = "", signUpUrl: t13 = "", isSatellite: r13 = false, domain: i12 = "", proxyUrl: s12 = "", reason: n11 = an, message: a11 = "", headers: o12 = new Headers() } = {}) {
            ...
            let l10 = "function" == typeof a10 ? await a10(r12) : a10, c2 = await lQ((e12) => {
              var t12;
              return null == (t12 = r12.cookies.get(e12)) ? void 0 : t12.value;
            }), u2 = !(l10.publishableKey || a6 || (null == c2 ? void 0 : c2.publishableKey)), d2 = null != (n11 = null == (s11 = ox(r12, rM)) ? void 0 : s11.replace("Bearer ", "")) ? n11 : "";
            return u2 && !i6(d2) ? t11(r12, i11) : e11(r12, i11);
          }, o10 = async (t12, i11) => oo ? r11(t12, i11) : e11(t12, i11);
          return i10 && s10 ? o10(i10, s10) : o10;
        });
      })();
      e.s(["config", 0, { matcher: ["/((?!_next|[^?]*\\.(?:html?|css|js(?!on)|jpe?g|webp|png|gif|svg|ttf|woff2?|ico|csv|docx?|xlsx?|zip|webmanifest)).*)", "/(api|trpc)(.*)"] }, "default", 0, cd], 56414);
      var ch = e.i(56414);
      e.i(94781);
      let cp = { ...ch }, cf = "/middleware", cm = cp.middleware || cp.default;
      ...
      e.s(["default", 0, (e10) => e6({ ...e10, page: cf, handler: async (...e11) => {
        try {
          return await cm(...e11);
        } catch (s10) {
